...
export default function Work() {
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <Link href="https://github.com/knlrvr" className="group flex items-center gap-1 text-xs group w-fit mt-8 border border-mist-500 px-4 py-1 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors duration-150">
