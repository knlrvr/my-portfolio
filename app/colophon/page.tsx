    ...
    return (
        <div className="max-w-2xl mx-auto mb-12">
            ...
            <div className="flex flex-col space-y-16 my-4 text-sm">
                ...
                <div className="">
                    <span className="font-bold tracking-tight">Ethos</span>
                ...
                <div className="">
                    <span className="font-bold tracking-tight">Typography</span>
                    <p className="text-neutral-600 dark:text-neutral-400 blog">
                ...
                <div className="">
                    <span className="font-bold tracking-tight">Tech Stack</span>
                    <p className="text-neutral-600 dark:text-neutral-400 blog">
                ...
                <div className="">
                    <span className="font-bold tracking-tight">Tailwind</span>
                    <p className="text-neutral-600 dark:text-neutral-400 blog">
                ...
                <div className="">
                    <span className="font-bold tracking-tight">Next.js & Vercel</span>
                    <p className="text-neutral-600 dark:text-neutral-400 blog">
