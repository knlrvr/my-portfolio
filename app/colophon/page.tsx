        ...
        <div className="max-w-2xl mx-auto mb-12">
            ...
            <div className="flex flex-col">
                ...
                <div className="">
                    ...
                    <div className="mt-6">
                        <Link href="https://github.com/knlrvr/my-portfolio" className="group inline-flex items-center gap-1 text-xs group w-fit border border-neutral-300 dark:border-neutral-700 px-2 py-0.5 rounded-md hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors duration-150">
                            <span className="text-neutral-700 dark:text-neutral-300">
                                GitHub Repo
                            </span>
                            <LuArrowUpRight className="mt-0.5 text-blue-400 group-hover:-translate-y-px group-hover:translate-x-px transition-transform duration-150" />
                        </Link>
                    </div>
                </div>
