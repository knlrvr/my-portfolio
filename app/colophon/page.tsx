    ...
    return (
        <div className="max-w-sm mx-auto mb-12">
            ...
            <div className="flex flex-col">
                ...
                <div className="">
                    <SectionBreakSmall num="01" label="ethos" />
                    <Reveal delay={0.16}>
                        <p className="text-sm">
                ...
                <div className="">
                    <SectionBreakSmall num="02" label="typography" />
                    <Reveal delay={0.16}>
                        <p className="text-sm">
                ...
                <div className="">
                    <SectionBreakSmall num="03" label="tech stack" />
                    <Reveal delay={0.16}>
                        <p className="text-sm">
                    ...
                    <Reveal delay={0.32}>
                        ...
                        >
                            ...
                            <div className="bg-mist-300 dark:bg-mist-700 text-mist-700 dark:text-mist-300 p-3 rounded-full">
                ...
                <div className="">
                    <SectionBreakSmall num="04" label="typescript" />
                    <Reveal delay={0.16}>
                        <p className="text-sm">
                            <em>Obviously</em>.
                        </p>
                ...
                <div className="">
                    <SectionBreakSmall num="05" label="tailwind" />
                    <Reveal delay={0.16}>
                        <p className="text-sm">
                ...
                <div className="">
                    <SectionBreakSmall num="06" label="next.js & vercel" />
                    <Reveal delay={0.16}>
                        <p className="text-sm">
                ...
                <div className="">
                    <SectionBreakSmall num="07" label="domain name" />
                    <Reveal delay={0.16}>
                        <p className="text-sm">
