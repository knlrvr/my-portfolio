        ...
        <div className="max-w-2xl mx-auto mb-12">
            ...
            <div className="flex flex-col space-y-16 my-4 text-sm">
                ...
                <div className="">
                    ...
                    <div className="mt-3">
                        <Link href="https://github.com/knlrvr/my-portfolio" target="_blank" className="text-neutral-500 underline underline-offset-2 decoration-neutral-300 hover:decoration-neutral-500 dark:decoration-neutral-500 dark:hover:decoration-neutral-300 transition duration-100">GitHub Repo</Link>
                    </div>
                </div>
