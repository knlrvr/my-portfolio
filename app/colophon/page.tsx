        ...
        <div className="max-w-2xl mx-auto mb-12">
            ...
            <div className="flex flex-col space-y-16 my-4 text-sm">
                ...
                <div className="">
                    ...
                    <div className="mt-3">
                        <Link href="https://github.com/knlrvr/my-portfolio" target="_blank" className="text-neutral-500 underline underline-offset-2 decoration-neutral-300 hover:decoration-neutral-500 transition-colors duration-150">GitHub Repo</Link>
                    </div>
                </div>
