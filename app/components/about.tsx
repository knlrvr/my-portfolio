        ...
        <div className="text-sm my-8">
            <div className="flex flex-col gap-4 pb-4">
                ...
                <p className="text-neutral-600 dark:text-neutral-300 blog">
                    ...
                    artist, and d&d nerd living in North Carolina. Currently working as a <span className="underline underline-offset-2 decoration-neutral-300">QA Analyst at Rather Outdoors</span>.
